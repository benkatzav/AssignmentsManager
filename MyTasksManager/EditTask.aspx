<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTask.aspx.cs" Inherits="MyTasksManager.EditTask" %>
        ...
        <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <asp:DropDownList id="dropUsers" runat="server" class="form-control">
                  </asp:DropDownList>
               </div>
            </div>
        </div>
        <asp:Button ID="btnConfirm" runat="server" Height="30px" OnClick="BtnConfirm_Click" Text="Confirm Changes" />
        <asp:Button ID="btnBack" runat="server" Height="30px" Text="Back to assignments" PostBackUrl="~/TasksWebForm.aspx" />
        <div>
